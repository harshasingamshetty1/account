...
contract DeployTestExecuteInitiates is Script {
    ...
    function deployContracts() public {
        ...
        console.log("========================================");
        console.log("Run: forge script script/DeployTestExecuteInitiates.s.sol --sig \"executeWithMultisig()\" --rpc-url http://localhost:8545 --broadcast");
        console.log("========================================\n");
    }
    ...
    function executeWithMultisig() public {
        ...
        initiator = Initiator(0x5FC8d32690cc91D4c39d9d3abcBD16989F875707);
    ...
    function grantSigner1PermissionsWithMultisig() internal {
        ...
        // Grant permission to call approve on testToken
        ...
        // Grant permission to call initiate on Initiator
        ...
        console.log("[OK] signer1 granted canExecute (approve + initiate) + spend limit\n");
    }
    ...
    function signer1TransfersTokens() internal {
        ...
        // Step 1: Approve Initiator to spend tokens
        calls[0] = ERC7821.Call({
            to: address(testToken),
            value: 0,
            data: abi.encodeWithSignature("approve(address,uint256)", address(initiator), amount)
        });
        // Step 2: Call initiate on Initiator contract
        calls[1] = ERC7821.Call({
        ...
        console.log("[OK] signer1 initiated transfer of", amount, "TT to Initiator");
