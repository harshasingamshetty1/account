...
/// @notice Script to whitelist an address in GardenSolver via hardware wallet signature
contract WhitelistAddress is Script {
    function run() public {
        ...
        console.log("WhitelistDigest:", vm.toString(digest));
        ...
        console.log("\nBroadcasting whitelist transaction");
