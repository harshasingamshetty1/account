...
/// @notice Script to grant HTLC permissions to executor via hardware wallet
/// @dev Usage:
///
///      Step 1 - Get permissions digest to sign:
///      forge script script/main/GrantHTLCPermissions.s.sol --rpc-url $RPC_URL
///
///      Step 2 - Sign the permissions digest with Ledger:
///      cast wallet sign --ledger <PERM_DIGEST_FROM_STEP_1>
///      export SIGNATURE_PERM=<SIGNATURE_FROM_STEP_2>
///
///      Step 3 - Broadcast permissions grant:
///      forge script script/main/GrantHTLCPermissions.s.sol --rpc-url $RPC_URL --broadcast
///
...
contract GrantHTLCPermissions is Script {
    function run() public {
        ...
        console.log("\n========================================");
        console.log("Grant HTLC Permissions");
        console.log("========================================");
        ...
        console.log("\n========================================");
        console.log("PERMISSIONS - SIGNING INFORMATION");
        console.log("========================================");
